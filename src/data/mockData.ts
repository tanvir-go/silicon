...
export const teamData: TeamMember[] = [
  ...
  },
  {
    ...
    bio: "Creative designer crafting dynamic design systems, high-fidelity mockups, and client flows.",
    image: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&q=80&w=400&h=400",
    linkedin: "https://linkedin.com",
    twitter: "https://twitter.com",
    email: "farhana.design@siliconcomputing.com",
    department: "creative",
    badge: "SF-24",
    education: "B.FA. in Graphic Design & UI/UX",
    skills: ["UI/UX Prototyping", "Design Systems", "Figma", "User Journey Mapping"],
    story: [
      "Farhana Yasmin leads the visual direction of our custom web layouts, mapping interactive component journeys for SaaS applications.",
      "Her design assets focus on readability, vibrant accents, and sleek layouts that feel premium and modern."
    ]
  },
  {
    id: "arif-hossain",
    name: "Arif Hossain",
    role: "BRAND IDENTITY VISUALIZER",
    bio: "Visualizer creating brand patterns, custom graphics, and marketing assets.",
    image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=400&h=400",
    linkedin: "https://linkedin.com",
    twitter: "https://twitter.com",
    email: "arif.brand@siliconcomputing.com",
    department: "creative",
    badge: "SF-24",
    education: "B.Sc. in Multimedia & Creative Technology",
    skills: ["Brand Identity", "Vector Graphics", "Animation Assets", "Creative Layouts"],
    story: [
      "Arif Hossain shapes the corporate identity and digital presentation of Silicon Computing, aligning brand assets across all products.",
      "His custom vector drawings and grid patterns help keep our layout pages feeling responsive, alive, and interactive."
    ]
  },
  {
    id: "md-nasimul-alam",
